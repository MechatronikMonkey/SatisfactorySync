...
Just the FTP login credentials and you are good to go. Share the credentials with your friends who play.
And do not hand them to others, and you should be good.
...
From here there are **two cases**. You may download a game that friends already uploaded, or you first upload a game.
...
Press the red DOWN arrow to download the save game for the first time.
...
After that a new window will appear for you to select the destination of that save game.
...
Then you know nobody is playing anymore, but the game was last finished by player-A at 06:42:42
...
Talk to each other, and only click "Ja" if you are absolutely sure!
...
## Start a new game
First of all get the FTP credentials of a free FTP server or your webspace or the FTP of a friend or so.
...
3. Enter a NEW NAME (must be unique on server) for a settings file. Give it a good name, maybe the players curently playing. 
...
4. Use the picker to select the save game you want to share with your friends. It tries to throw you in the default save game path
...
### First Upload ###
Switch to Sync Tab if not already done.
As you see there is no name or date for up and downloads of this save game to your ftp server.
This is because you never uploaded the save game.

So click the green upload arrow to first upload the save game to the server.
...
## Export settings ###
After your first upload you should save the settings for your friends to make it easier for them to set up.
